...
@property (strong, nonatomic) UIColor *animatedViewColor UI_APPEARANCE_SELECTOR;      // default is [UIColor blackColor]
...
@property (strong, nonatomic) UIImage *centerImage UI_APPEARANCE_SELECTOR;          // default is nil, only used if provided
...
+ (void)setAnimatedViewColor:(UIColor*)color;                       // default is [UIColor blackColor], only used for
