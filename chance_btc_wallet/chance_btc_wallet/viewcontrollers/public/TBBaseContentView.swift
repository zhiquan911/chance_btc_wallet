...
class TBBaseContentView: ESTabBarItemContentView {

    override init(frame: CGRect) {
        super.init(frame: frame)
        textColor = UIColor.init(white: 175.0 / 255.0, alpha: 1.0)
        highlightTextColor = UIColor(hex: 0x49c689)
        iconColor = UIColor.init(white: 175.0 / 255.0, alpha: 1.0)
        highlightIconColor = UIColor(hex: 0x49c689)
    }
...
class TBBouncesContentView: TBBaseContentView {
...
class TBIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = UIColor(hex: 0x49c689)
        self.imageView.layer.borderWidth = 4.0
        self.imageView.layer.borderColor = UIColor.init(white: 245 / 255.0, alpha: 1.0).cgColor
